...
const OtherProjects = () => {
  return (
    <section className="flex flex-col items-center">
      ...
      <a
        href="https://github.com/KasiePatricia?tab=repositories"
        className="text-sm text-mGreen"
      >
        Other projects
      </a>
      <ul className="pj-continue grid gap-4 relative mt-12">
          ...
          <div className="flex justify-between  flex-col relative h-full rounded bg-[#112240] overflow-auto py-8 px-7 box-showder-m">
            <header>
              <div className="flex justify-between items-center mb-9">
                <div className="text-mGreen">
                  <svg
                    ...
                    className="feather feather-folder w-5 h-5"
                  >
                    <title>Folder</title>
                ...
                <div className="flex gap-2 items-center text-[#a8b2d1]">
                  <a
                    href="https://github.com/KasiePatricia/todo-app"
                  ...
                  <a
                    href="https://todo-app-brown-one.vercel.app"
              ...
              <h3 className="text-xl">
                <a
                  href="https://todo-app-brown-one.vercel.app"
                  //https://todo-app-kk3z.vercel.app/
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  To-Do App
          ...
          <div className="flex justify-between  flex-col relative h-full rounded bg-[#112240] overflow-auto py-8 px-7 box-showder-m">
            <header>
              <div className="flex justify-between items-center mb-9">
                ...
                <div className="flex gap-2 items-center text-[#a8b2d1]">
                  <a
                    href="https://github.com/KasiePatricia/stutern_projects/tree/movies/star-wars"
                    aria-label="GitHub Link"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a
                    href="https://stutern-projects-w2iz.vercel.app/"
                    aria-label="External Link"
                    className="external"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="flex justify-between  flex-col relative h-full rounded bg-[#112240] overflow-auto py-8 px-7 box-showder-m">
            <header>
              <div className="flex justify-between items-center mb-9">
                ...
                <div className="flex gap-2 items-center text-[#a8b2d1]">
                  <a
                    href="https://github.com/KasiePatricia/expenses-chart-components"
                    aria-label="GitHub Link"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a
                    href="https://expenses-chart-components.vercel.app"
                    aria-label="External Link"
                    className="external"
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <div className="flex justify-between  flex-col relative h-full rounded bg-[#112240] overflow-auto py-8 px-7 box-showder-m">
            <header>
              <div className="flex justify-between items-center mb-9">
                ...
                <div className="flex gap-2 items-center text-[#a8b2d1]">
                  <a
                    href="https://github.com/Visionvoice2023/therapy-app"
                    aria-label="GitHub Link"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  <a
                    href="https://therapy-app.vercel.app/"
                    aria-label="External Link"
                    className="external"
                    target="_blank"
                    rel="noopener noreferrer"
